...
| 25–28 | Extension (cold) | Edit requirements + re-run, runtime swap, or add standard | [extensions/README.md](../extensions/README.md) |
...
- "PgBouncer transaction pooling" → add to §3 of `INTEGRATION_REQUIREMENTS.md`, re-run onboard
