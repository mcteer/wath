...
| Repository | `https://github.com/example/orders-api` | the repo Wath will open the PR against |
| Owning team / contact | `payments` / `payments@example.com` | who reviews and merges the PR |
| Runtime | `kubernetes` | determines the auth method — pick one |
...
| Field | Your value | Notes |
|---|---|---|
| Datastore | `postgres` | the engine you need credentials for |
